    ...
    <div class="cart-box" id="cart-box">
      ...
      <div class="fd cle">
        ...
        <div class="fr" id="price-total">
          <p><span id="selectedCount">{{goods.goods_list.length}}</span>件商品，总价：<span class="red"><strong
        ...
        <textarea type="text" v-model="post_script" placeholder="请输入留言"
      ...
      balanceCount() { // 结算
        if (this.addrInfo.length == 0) {
          ...
          createOrder(
            ...
            //https://openapi.alipaydev.com/gateway.do?app_id=2016092300575166&biz_content=%7B%22subject%22%3A%22%5Cu54c8%5Cu5bc6%5Cu74dc%5Cu652f%5Cu4ed8%5Cu6d4b%5Cu8bd5%22%2C%22out_trade_no%22%3A%2220161112%22%2C%22total_amount%22%3A1148%2C%22product_code%22%3A%22FAST_INSTANT_TRADE_PAY%22%7D&charset=utf-8&method=alipay.trade.page.pay&notify_url=https%3A%2F%2Fexample.com%2Fnotify&return_url=http%3A%2F%2F127.0.0.1%3A8000%2Falipay%2Freturn&sign_type=RSA2&timestamp=2019-04-15+14%3A17%3A08&version=1.0&sign=oNtBYLaFcb9UzRlOwinav4kz6vl5MbdWEawkiIRr46QGV58088uwabKSmYhnmDTzl%2BsnF0uLDeROmSlQslDCWZc1MsCb6P1DmawHgnv6LZHq3dyfsvPQuPXyx5GxycRgnNX7%2FP%2BQclZ9DUPOngrfYvlh7q4jgDegGCeUYvRl3Z7q4L1729PRHqk%2F9KAhABBUowBKVXdVjpPkgSMh8bcu5%2FJAkw9Yv%2Bx38N79rkR8ehxF9k9ew6LXdqwq61TxARJr6tpD3ca3eDF3TSTt3ySBry2bz6IfA0ok6yo4%2Fsqzj9PZOiWM7HZOECXYfN6r%2Bc3q8jbIFEUgLy9QCqzIAfd9bg%3D%3D
          }).catch(function (error) {
            console.log(error);
          });
        }
